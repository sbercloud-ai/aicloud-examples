# Примеры работы с платформой Distributed Train от Cloud.ru

В репозитории приведены примеры использования платформы Distributed Train от начального до продвинутого уровня для решения ML-задач.
