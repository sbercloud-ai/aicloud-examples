...
2. Создайте новую папку и загрузите следующие файлы [через веб-интерфейс Jupyter Server](https://console.cloud.ru/spa/mlspace/env-jupyter-server) на платформе Distributed Train:
